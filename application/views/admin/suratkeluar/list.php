<div class="page-wrapper">
    <div class="page-content">
        <div class="col">
            ...
            <div class="row">
                <div class="col-md-3">
                    <a type="button" class="btn btn-primary" href="<?= base_url(); ?>Admin/Surat_Keluar/tambah">Tambah Surat Masuk</a>
                </div>
                <div class="col-md-9">
                    <form method="POST" action="<?= base_url(); ?>Admin/Surat_Keluar/multidelete" id="form-delete">
                        <button id="btn-delete" onclick="return confirm('yakin mau dihapus?')" class="btn btn-danger">Hapus</button>
                </div>
            </div>
            </br></br>
            <div class="card">
