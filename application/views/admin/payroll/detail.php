		...
		<div class="card">
			...
			<div class="card-body">
				<div class="p-4 border rounded">
					<form class="row g-3" action="<?= base_url('admin/payroll/detail/' . $gaji->id_gaji) ?>" method="post">
						<div class="row">
							<div class="col-md-12">
								<h6><strong>Data Gaji Tanggal <?= $gaji->tgl ?> || NIP Pegawai :<?= $gaji->nip ?>
									</strong></h6>
							</div>
							<div class="col-md-12">
								<h6>Atas Nama : <?= $gaji->atas_nama ?> | Nama Bank : <?= $gaji->nama_bank ?> | Nomor Rekening : <?= $gaji->no_rek ?></h6>
							</div>
						</div>
