<div class="page-wrapper">
    <div class="page-content">
        <div class="col">
            ...
            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" onclick="kat_lib_add_ajax()" data-bs-target="#kat_lib_modal_form">Tambah Kategori E-Lib</button>
            </br></br>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="modal-body">
                        <form action="" id="formkatlib" name="formdata" class="form-horizontal" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btnSavekatlib" onclick="kat_lib_save();" class="btn btn-primary btn-sm">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
