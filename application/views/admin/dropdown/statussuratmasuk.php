<div class="page-wrapper">
    <div class="page-content">
        <div class="col">
            ...
            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" onclick="status_surat_masuk_add_ajax()" data-bs-target="#status_surat_masuk_modal_form">Tambah Status Surat Masuk</button>
            </br></br>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="modal-body">
                        <form action="" id="formstatussuratmasuk" name="formdata" class="form-horizontal" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btnSavestatussuratmasuk" onclick="status_surat_masuk_save();" class="btn btn-primary btn-sm">Save changes</button>
                            </div>
                        </form>
                    </div>
                </div>
