					...
					<form class="row g-3" action="<?= base_url('admin/jabatan/tambah') ?>" method="post">
						<div class="row mb-2">
							<div class="col-md-4">
								...
								<input type="text" class="form-control" name="nama_jabatan" placeholder="Nama jabatan" value="<?= set_value('nama_jabatan') ?>">
								<?= form_error('nama_jabatan', '<small class="text-danger pl-3">', '</small>'); ?>
							</div>
							<div class="col-md-4">
								<label for="gapok">Gaji Pokok</label>
								<input type="text" class="form-control" name="gapok" placeholder="Gaji Pokok" value="<?= set_value('gapok') ?>">
								<?= form_error('gapok', '<small class="text-danger pl-3">', '</small>'); ?>
							</div>
							<div class="col-md-4">
								<label for="gaji_jabatan">Gaji Jabatan</label>
								<input type="text" class="form-control" name="gaji_jabatan" placeholder="Gaji jabatan" value="<?= set_value('gaji_jabatan') ?>">
