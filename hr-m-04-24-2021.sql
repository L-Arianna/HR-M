...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2021 at 04:06 AM
...
INSERT INTO `tbl_kegiatan_khazanah` (`id_keg_khazanah`, `jenis_keg_khazanah`, `idbuku_keg_khazanah`, `nobuku_keg_khazanah`, `stok_keg_khazanah`, `create_at_keg_khazanah`) VALUES
(1, 'a', 'a', 'a', 2, '2021-04-22 14:13:43');
...
INSERT INTO `tbl_khazanah` (`id_khazanah`, `kegiatan_khazanah`, `tujuan_khazanah`, `filelokasi_khazanah`, `masuk_khazanah`, `keluar_khazanah`, `petugas_khazanah`, `pengawas_khazanah`, `status_khazanah`) VALUES
...
(4, '3', 'operasional', '05/XXI/2021', '2021-04-23 10:06:20', NULL, 'Bambang', 'Budi', 1);
...
--
ALTER TABLE `tbl_kegiatan_khazanah`
  MODIFY `id_keg_khazanah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_khazanah`
--
ALTER TABLE `tbl_khazanah`
  MODIFY `id_khazanah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
