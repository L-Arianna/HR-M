...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2021 at 10:39 AM
...
INSERT INTO `tb_cuti` (`id_cuti`, `nip`, `id_kat_cuti`, `no_hp_darurat`, `alamat`, `keterangan`, `tgl_mulai`, `tgl_selesai`) VALUES
(13, 1509042021002, 1, '09989797923', 'Jl ahmad  12', 'asdasdadadsa', '2021-04-20', '2021-04-24');
...
INSERT INTO `tb_detail_cuti` (`id_detail_cuti`, `id_cuti`, `id_user`, `id_kat_cuti`, `nip`, `status`, `tgl`) VALUES
(10, 13, 18, 1, 1509042021002, 'pending', '2021-04-20 09:31:48');
...
--
ALTER TABLE `tb_detail_cuti`
  MODIFY `id_detail_cuti` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
